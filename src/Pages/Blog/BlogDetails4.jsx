            ...
            <div className='w-full lg:max-w-3xl mx-auto'>
                <PhotoProvider>
                    <PhotoView src={ nodejs }>
                        <img src={ nodejs } alt="" className='w-full' data-aos='fade-up' data-aos-duration='1000' />
                    </PhotoView>
                </PhotoProvider>
                <h1 className='text-3xl font-bold text-theme-dark my-5' data-aos='fade-up' data-aos-duration='1000'>How does Node JS handle multiple requests at the same time</h1>
