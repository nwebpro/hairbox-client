...
const ServicesItem = ({ service }) => {
    ...
    return (
        <div className='p-5 bg-white shadow-lg rounded-lg' data-aos='fade-up' data-aos-duration='1000'>
            <PhotoProvider>
                <PhotoView src={ serviceImage }>
                    <img src={ serviceImage } className='w-full min-h-[330px] object-cover mb-5 rounded-lg' alt="" />
                </PhotoView>
            </PhotoProvider>
            <Link to={`/service/${ _id }`}>
