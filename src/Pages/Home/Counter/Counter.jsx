...
const Counter = () => {
    return (
        <div className='md:mt-10 mb-20 bg-theme-dark py-20 px-10 rounded'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                <div className='text-center p-5' data-aos='fade-up' data-aos-duration='1000'>
                ...
                <div className='text-center p-5' data-aos='fade-up' data-aos-duration='1500'>
                ...
                <div className='text-center p-5' data-aos='fade-up' data-aos-duration='2000'>
